...
struct BarChartView: View {
    ...
    @StateObject var chartViewModel = HikingChartsViewModel()
    ...
    var body: some View {
        VStack (alignment: .leading) {
            ...
            if (selectedValue != "") {
                ...
                case .distance:
                    Text("Distance Hiked: \(selectedValue)")
                        .bold()
                case .time:
                    Text("Time Hiked: \(selectedValue)")
                        .bold()
                case .numberOfRoutes:
        ...
        .padding()
        .navigationBarTitle(HikingChartsViewModel.titleStrings[index], displayMode: .inline)
