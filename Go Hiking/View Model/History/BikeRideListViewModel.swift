...
class BikeRideListViewModel: ObservableObject {
    ...
    func getSortDescriptor() -> NSSortDescriptor {
        switch self.currentSortChoice {
            case .distanceAscending:
                return NSSortDescriptor(keyPath: \BikeRide.hikingDistance, ascending: true)
            case .distanceDescending:
                return NSSortDescriptor(keyPath: \BikeRide.hikingDistance, ascending: false)
            case .dateAscending:
                return NSSortDescriptor(keyPath: \BikeRide.hikingStartTime, ascending: true)
            case .dateDescending:
                return NSSortDescriptor(keyPath: \BikeRide.hikingStartTime, ascending: false)
            case .timeAscending:
                return NSSortDescriptor(keyPath: \BikeRide.hikingTime, ascending: true)
            case .timeDescending:
                return NSSortDescriptor(keyPath: \BikeRide.hikingTime, ascending: false)
        }
    }
